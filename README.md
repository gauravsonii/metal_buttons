...
```sh
npx shadcn@latest add https://button.gauravsoni/r/metal-button.json
```

For pnpm:

```sh
pnpm dlx shadcn@latest add https://button.gauravsoni/r/metal-button.json
```

For bun:

```sh
bunx --bun shadcn@latest add https://button.gauravsoni/r/metal-button.json
```
...
If you like this and other projects, you can sponsor me on [GitHub](https://github.com/sponsors/gauravsonii) or
[buying me a coffee](https://www.buymeacoffee.com/gauravsoni).
